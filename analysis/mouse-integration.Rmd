...
Annotate features with identifier and name:
...
mnn$source[mnn$batch == "AL_KDR_HET_C"] <- "Allantois-Het"

mnn$source[mnn$batch == "AL_KDR_HOM_D"] <- "Allantois-Hom"
```

Create tissue annotation label:

```{r}
mnn$tissue <- "Atlas"

mnn$tissue[mnn$batch == "AL_KDR_HET_C"] <- "Allantois"

mnn$tissue[mnn$batch == "AL_KDR_HOM_D"] <- "Allantois"
```
...
mnn$source[mnn$batch == "AL_KDR_HET_C"] <- "Het"

mnn$source[mnn$batch == "AL_KDR_HOM_D"] <- "Hom"
```
