---
title: "Mouse pseudotime (Supplementary)"
...
knitr::opts_chunk$set(
  autodep    = TRUE,
  cache      = TRUE,
  cache.path = "cache/mouse-pseudotime-supp.Rmd/",
  dev        = "png",
  error      = FALSE,
  message    = FALSE,
  warning    = FALSE
...
```{r}
sce <- readRDS("output/mouse-trajectory-supp.rds")
```
...
saveRDS(sce, file = "output/mouse-pseudotime-supp.rds")
```
