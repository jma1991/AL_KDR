---
title: "Mouse pseudotime (Endothelium)"
...
knitr::opts_chunk$set(
  autodep    = TRUE,
  cache      = TRUE,
  cache.path = "cache/mouse-pseudotime-endothelium.Rmd/",
  dev        = "png",
  error      = FALSE,
  message    = FALSE,
  warning    = FALSE
...
```{r}
sce <- readRDS("output/mouse-trajectory-endothelium.rds")
```
...
saveRDS(sce, file = "output/mouse-pseudotime-endothelium.rds")
```
